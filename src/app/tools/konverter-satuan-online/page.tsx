...
export const metadata: Metadata = {
  title: 'Konverter Satuan Online',
  description: 'Konverter Satuan Online gratis online. Cocok untuk yang nyari "kalkulator cm ke m". Mudah dipakai, hasil instan.',
  alternates: { canonical: 'https://www.sesoris.com/tools/konverter-satuan-online/' },
};
  ...
  return (
    <article className="max-w-3xl mx-auto px-6 py-8">
      ...
      <Script id="article-schema" type="application/ld+json">
        {JSON.stringify({"@context":"https://schema.org","@type":"Article","headline":"Konverter Satuan Online","description":"Konverter Satuan Online gratis online. Cocok untuk yang nyari \"kalkulator cm ke m\". Mudah dipakai, hasil instan.","url":"https://www.sesoris.com/tools/konverter-satuan-online/"})}
      </Script>
      <Script id="faq-schema" type="application/ld+json">
        {JSON.stringify({"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"Apa itu Konverter Satuan Online?","acceptedAnswer":{"@type":"Answer","text":"Konverter Satuan Online adalah tool gratis online yang bantu kamu hitung dengan cepat tanpa perlu install aplikasi."}},{"@type":"Question","name":"Bagaimana cara pakai Konverter Satuan Online?","acceptedAnswer":{"@type":"Answer","text":"Isi field input di atas, klik tombol \"Hitung\", hasilnya muncul instan. Reset kalau mau hitung ulang."}},{"@type":"Question","name":"Apakah Konverter Satuan Online gratis?","acceptedAnswer":{"@type":"Answer","text":"Ya, 100% gratis. Tidak perlu daftar atau login."}},{"@type":"Question","name":"Apakah hasil Konverter Satuan Online akurat?","acceptedAnswer":{"@type":"Answer","text":"Akurat sesuai formula standar. Hasil ini panduan; konsultasi ahli kalau butuh keputusan penting."}},{"@type":"Question","name":"Bisa dipakai di HP?","acceptedAnswer":{"@type":"Answer","text":"Bisa. Tool ini responsive dan jalan di HP, tablet, dan desktop."}}]})}
      </Script>
    </article>
  );
}
