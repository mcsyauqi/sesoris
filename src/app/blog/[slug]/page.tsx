...
export default async function BlogPostPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const revisionMarker = {
    ...
    'corner-shelf-ideas': 'sesoris-2026-09-11-article-gate-v1',
    'newborn-closet-organization': 'sesoris-2026-09-11-article-gate-v1',
    'purse-storage-ideas': 'sesoris-2026-09-11-article-gate-v1',
