    ...
    <div className="min-h-screen bg-[#F8F9FA] flex items-center justify-center py-12 px-4">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl p-8 shadow-lg">
          <div className="text-center mb-8">
            <h1 className="text-2xl font-bold text-[#212529]">Welcome Back</h1>
            <p className="text-[#6C757D] mt-1">Sign in to your account</p>
          </div>
          ...
          <p className="mt-8 text-center text-sm text-[#6C757D]">
            ...
            <Link href="/account/register" className="text-[#1B5E3B] hover:underline font-medium">
              Create one
            </Link>
          </p>
        </div>
