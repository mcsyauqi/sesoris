...
This organizer is perfect for home offices, workplaces, or as a gift for colleagues. With proper care, this product will last for years and become even more beautiful over time.`,
    ...
    images: [
      { url: 'https://images.unsplash.com/photo-1544816155-12df9643f363?w=600&h=600&fit=crop', alt: 'Bamboo Desk Organizer front view' },
      { url: 'https://images.unsplash.com/photo-1593642632559-0c6d3fc62b89?w=600&h=600&fit=crop', alt: 'Bamboo Desk Organizer on workspace' },
      { url: 'https://images.unsplash.com/photo-1490367532201-b9bc1dc483f6?w=600&h=600&fit=crop', alt: 'Bamboo Desk Organizer compartment detail' },
    ],
...
The ergonomic design with an anti-slip grip makes it easy to carry this bottle anywhere — the gym, office, or outdoors. The secure one-touch lid prevents spills and can be easily opened with one hand.`,
    ...
    price: 349000,
    images: [
      { url: 'https://images.unsplash.com/photo-1602143407151-7111542de6e8?w=600&h=600&fit=crop', alt: 'Smart Water Bottle front view' },
      { url: 'https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?w=600&h=600&fit=crop', alt: 'Smart Water Bottle during workout' },
      { url: 'https://images.unsplash.com/photo-1523362628745-0c100150b504?w=600&h=600&fit=crop', alt: 'Smart Water Bottle LED screen detail' },
    ],
...
The 360° flexible neck allows you to direct light to the exact position needed. The memory function remembers your last settings, and the automatic 30/60-minute timer helps save energy. Sensitive touch controls make operation effortless.`,
    ...
    price: 499000,
    images: [
      { url: 'https://images.unsplash.com/photo-1507473885765-e6ed057f782c?w=600&h=600&fit=crop', alt: 'LED Desk Lamp front view' },
      { url: 'https://images.unsplash.com/photo-1497366216548-37526070297c?w=600&h=600&fit=crop', alt: 'LED Desk Lamp on workspace' },
      { url: 'https://images.unsplash.com/photo-1524758631624-e2822e304c36?w=600&h=600&fit=crop', alt: 'LED Desk Lamp room ambiance' },
    ],
...
Perfect for various occasions: birthdays, anniversaries, Mother's Day, or simply to show appreciation to loved ones. The beautiful packaging means you don't need to wrap it again — it's ready to give.`,
    ...
    images: [
      { url: 'https://images.unsplash.com/photo-1549465220-1a8b9238cd48?w=600&h=600&fit=crop', alt: 'Premium Gift Box Set top view' },
      { url: 'https://images.unsplash.com/photo-1607344645866-009c320b63e0?w=600&h=600&fit=crop', alt: 'Premium Gift Box Set package contents' },
      { url: 'https://images.unsplash.com/photo-1576426863848-c21f53c60b19?w=600&h=600&fit=crop', alt: 'Premium Gift Box Set self-care products' },
    ],
...
Hand-stitched with waxed thread for long-lasting durability. The leather will develop a natural patina over time, giving your wallet a unique character. Available in 3 classic colors: Black, Brown, and Tan.`,
    ...
    price: 399000,
    images: [
      { url: 'https://images.unsplash.com/photo-1627123424574-724758594e93?w=600&h=600&fit=crop', alt: 'Minimalist Wallet front view' },
      { url: 'https://images.unsplash.com/photo-1548036328-c9fa89d128fa?w=600&h=600&fit=crop', alt: 'Minimalist Wallet leather material' },
      { url: 'https://images.unsplash.com/photo-1591561954557-26941169b49e?w=600&h=600&fit=crop', alt: 'Minimalist Wallet stitching detail' },
    ],
...
Battery lasts up to 8 hours per charge with ANC on, or 10 hours with ANC off. The charging case provides an additional 24 hours, totaling 32 hours of playtime. A 10-minute fast charge gives 2 hours of use. Wireless charging compatible.`,
    ...
    images: [
      { url: 'https://images.unsplash.com/photo-1590658165737-15a047b7c0b0?w=600&h=600&fit=crop', alt: 'Wireless Earbuds Pro front view' },
      { url: 'https://images.unsplash.com/photo-1505740420928-5e560c06d30e?w=600&h=600&fit=crop', alt: 'Wireless Earbuds Pro with case' },
...
The jar is made from BPA-free Tritan that is food-safe, impact-resistant, and doesn't retain odors. Easy to clean — just fill with water and soap, then run the blender. The leak-proof design allows you to drink directly from the jar or carry it in your bag.`,
    ...
    images: [
      { url: 'https://images.unsplash.com/photo-1570197571499-166b36435e9f?w=600&h=600&fit=crop', alt: 'Portable Blender front view' },
      { url: 'https://images.unsplash.com/photo-1610970881699-44a5587cabec?w=600&h=600&fit=crop', alt: 'Portable Blender with smoothie ingredients' },
      { url: 'https://images.unsplash.com/photo-1490645935967-10de6ba17061?w=600&h=600&fit=crop', alt: 'Portable Blender finished smoothie' },
    ],
    category: categories[1],
    rating: 0,
    reviewCount: 0,
...
Auto shut-off when the water runs out protects the unit from damage and ensures safety. Whisper-quiet operation below 30dB won't disturb your sleep or work concentration. The elegant wood grain design suits various interior styles.`,
    ...
    price: 329000,
    images: [
      { url: 'https://images.unsplash.com/photo-1600612253971-422e7f7faeb6?w=600&h=600&fit=crop', alt: 'Aromatherapy Diffuser front view' },
      { url: 'https://images.unsplash.com/photo-1515377905703-c4788e51af15?w=600&h=600&fit=crop', alt: 'Aromatherapy Diffuser relaxing ambiance' },
      { url: 'https://images.unsplash.com/photo-1544161515-4ab6ce6db874?w=600&h=600&fit=crop', alt: 'Aromatherapy Diffuser with candles' },
    ],
    category: categories[4],
    rating: 0,
    reviewCount: 0,
...
The high-temperature firing process produces strong and durable ceramic. The smooth glazed surface is easy to clean and does not absorb water. The bamboo saucer adds a natural touch and protects furniture surfaces from water.`,
    ...
    price: 449000,
    images: [
      { url: 'https://images.unsplash.com/photo-1485955900006-10f4d324d411?w=600&h=600&fit=crop', alt: 'Ceramic Plant Pot Set front view' },
      { url: 'https://images.unsplash.com/photo-1416879595882-3373a0480b5b?w=600&h=600&fit=crop', alt: 'Ceramic Plant Pot Set with plants' },
      { url: 'https://images.unsplash.com/photo-1463936575829-25148e1db1b8?w=600&h=600&fit=crop', alt: 'Ceramic Plant Pot Set room setting' },
    ],
    category: categories[0],
    rating: 0,
    reviewCount: 0,
...
The stainless steel body with G10 insets provides a secure grip even when wet. Compact dimensions (9cm closed) and lightweight (140g) make it easy to carry in your pocket or attach to a keychain. A nylon pouch is included for storage and protection.`,
    ...
    price: 279000,
    images: [
      { url: 'https://images.unsplash.com/photo-1534073828943-f801091bb18c?w=600&h=600&fit=crop', alt: 'Multi-Tool Pocket Knife front view' },
      { url: 'https://images.unsplash.com/photo-1572981779307-38b8cabb2407?w=600&h=600&fit=crop', alt: 'Multi-Tool Pocket Knife all functions' },
      { url: 'https://images.unsplash.com/photo-1530046339160-ce3e530c7d2f?w=600&h=600&fit=crop', alt: 'Multi-Tool Pocket Knife blade detail' },
    ],
...
A transparent label holder on the front allows you to identify contents easily without opening. Available in neutral colors that suit various interiors. Easy to clean with a damp cloth for light stains.`,
    ...
    price: 229000,
    images: [
      { url: 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=600&h=600&fit=crop', alt: 'Foldable Storage Bins front view' },
      { url: 'https://images.unsplash.com/photo-1484154218962-a197022b5858?w=600&h=600&fit=crop', alt: 'Foldable Storage Bins in cabinet' },
      { url: 'https://images.unsplash.com/photo-1600585154526-990dced4db0d?w=600&h=600&fit=crop', alt: 'Foldable Storage Bins home setting' },
    ],
    category: categories[0],
    rating: 0,
    reviewCount: 0,
...
The complete set includes: electric opener, charging base/stand, foil cutter for removing seals, vacuum wine stopper for preserving unfinished wine, and wine pourer aerator for optimizing wine aroma and flavor. All accessories are neatly stored in an elegant gift box.`,
    ...
    price: 369000,
    images: [
      { url: 'https://images.unsplash.com/photo-1510812431401-41d2bd2722f3?w=600&h=600&fit=crop', alt: 'Electric Wine Opener front view' },
      { url: 'https://images.unsplash.com/photo-1474722883778-792e7990302f?w=600&h=600&fit=crop', alt: 'Electric Wine Opener opening a bottle' },
      { url: 'https://images.unsplash.com/photo-1544145945-f90425340c7e?w=600&h=600&fit=crop', alt: 'Electric Wine Opener with accessories' },
    ],
    category: categories[1],
    rating: 0,
    reviewCount: 0,
...
Easy to assemble without tools, set up in just 5 minutes. The sturdy structure can hold up to 15 kg. The brushed steel finish provides a modern look that suits various kitchen styles.`,
    ...
    images: [
      { url: 'https://images.unsplash.com/photo-1556909114-44e3e70034e2?w=600&h=600&fit=crop', alt: 'Stainless steel 2-tier dish rack front view' },
      { url: 'https://images.unsplash.com/photo-1584568694244-14fbdf83bd30?w=600&h=600&fit=crop', alt: 'Dish rack with plates and glasses' },
      { url: 'https://images.unsplash.com/photo-1556910103-1c02745aae4d?w=600&h=600&fit=crop', alt: 'Dish rack in minimalist kitchen' },
    ],
    category: categories[1],
    rating: 0,
    reviewCount: 0,
...
The slim dimensions (60 x 30 cm footprint) make this rack ideal for tight spaces like hallways, behind doors, or room corners. It weighs only 2 kg yet can support a total load of 25 kg. Available in black, white, and gray.`,
    ...
    images: [
      { url: 'https://images.unsplash.com/photo-1595341888016-a392ef81b7de?w=600&h=600&fit=crop', alt: 'Minimalist 5-tier shoe rack' },
      { url: 'https://images.unsplash.com/photo-1556228578-0d85b1a4d571?w=600&h=600&fit=crop', alt: 'Shoe rack with various shoes' },
      { url: 'https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=600&h=600&fit=crop', alt: 'Shoe rack in home entryway' },
    ],
    category: categories[0],
    rating: 0,
    reviewCount: 0,
...
Perfect for displaying decorative plants, favorite books, family photos, or decor collections. Each shelf's 5 kg load capacity allows you to safely place various items. This set is available in natural, walnut, and white.`,
    ...
    price: 249000,
    images: [
      { url: 'https://images.unsplash.com/photo-1532372576444-dda954194ad0?w=600&h=600&fit=crop', alt: 'Floating shelf set on living room wall' },
      { url: 'https://images.unsplash.com/photo-1594620302200-9a762244a156?w=600&h=600&fit=crop', alt: 'Floating shelf with plant decorations' },
      { url: 'https://images.unsplash.com/photo-1618220179428-22790b461013?w=600&h=600&fit=crop', alt: 'Floating shelf natural wood detail' },
    ],
    category: categories[0],
    rating: 0,
    reviewCount: 0,
...
N52-grade neodymium magnets — the highest grade — can hold up to 500 grams per point, strong enough for even the heaviest keychains. The wood surface is coated with clear coat for long-lasting protection.`,
    ...
    price: 159000,
    images: [
      { url: 'https://images.unsplash.com/photo-1558618666-fcd25c85f82e?w=600&h=600&fit=crop', alt: 'Magnetic wall key holder in walnut' },
      { url: 'https://images.unsplash.com/photo-1585412459212-4ab91ece49c3?w=600&h=600&fit=crop', alt: 'Key holder with keys attached' },
      { url: 'https://images.unsplash.com/photo-1513694203232-719a280e022f?w=600&h=600&fit=crop', alt: 'Key holder in home entryway' },
    ],
    category: categories[0],
    rating: 0,
    reviewCount: 0,
...
The feet feature adjustable levelers for uneven floors. The compact dimensions (80 x 30 cm footprint) make it fit perfectly in office corners, living rooms, or bedrooms. The total load capacity of 40 kg is evenly distributed across 4 tiers.`,
    ...
    compareAtPrice: 799000,
    images: [
      { url: 'https://images.unsplash.com/photo-1594620302200-9a762244a156?w=600&h=600&fit=crop', alt: 'Industrial bookshelf front view' },
      { url: 'https://images.unsplash.com/photo-1507842217343-583bb7270b66?w=600&h=600&fit=crop', alt: 'Bookshelf with book collection' },
      { url: 'https://images.unsplash.com/photo-1555041469-a586c61ea9bc?w=600&h=600&fit=crop', alt: 'Bookshelf in living room' },
    ],
    category: categories[0],
    rating: 0,
    reviewCount: 0,
