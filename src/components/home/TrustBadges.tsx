...
const badges = [
  { icon: Truck, title: 'Gratis Ongkir', desc: 'Pesanan di atas Rp 200rb' },
  { icon: RefreshCw, title: 'Mudah Dikembalikan', desc: '30 Hari' },
  { icon: Shield, title: 'Pembayaran Aman', desc: '100% Terlindungi' },
  { icon: Headphones, title: 'Layanan 24/7', desc: 'Selalu Siap Membantu' },
];
