...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    return [
      ...
      // Disabled 2026-06-26 by MinTiv for active Sesoris article slugs: { source: '/blog/:path((?!cara-menata-dapur-kecil-apartemen$).*cara-menata.*)', destination: '/blog', permanent: true },
      ...
      // Disabled 2026-06-26 by MinTiv for active Sesoris article slugs: { source: '/blog/:path((?!(checklist-persiapan-lebaran-bersih-bersih-rumah|ide-hampers-lebaran-dengan-produk-rumah-tangga)$).*lebaran.*)', destination: '/blog', permanent: true },
      // Disabled 2026-06-26 by MinTiv for active Sesoris article slugs: { source: '/blog/:path((?!(checklist-persiapan-lebaran-bersih-bersih-rumah|tips-bersih-bersih-rumah-cepat-30-menit)$).*bersih-bersih.*)', destination: '/blog', permanent: true },
