...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: '/blog/:path((?!rak-sudut-kamar-mandi-maksimalkan-ruang-mati$).*kamar-mandi.*)', destination: '/blog', permanent: true },
      ...
      { source: '/blog/:path((?!setup-wfh-produktif-di-rumah-minimalis$).*di-rumah.*)', destination: '/blog', permanent: true },
      ...
      { source: '/blog/:path((?!wardrobe-organizer-cara-menata-lemari-pakaian$).*lemari-pakaian.*)', destination: '/blog', permanent: true },
      ...
      { source: '/blog/:path((?!cara-menata-dapur-kecil-apartemen$).*cara-menata.*)', destination: '/blog', permanent: true },
      ...
      { source: '/blog/:path((?!(checklist-persiapan-lebaran-bersih-bersih-rumah|ide-hampers-lebaran-dengan-produk-rumah-tangga)$).*lebaran.*)', destination: '/blog', permanent: true },
